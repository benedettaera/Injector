...
local function checkAuthorization()
    ...
    local authorizedUsers = loadstring(game:HttpGet("https://raw.githubusercontent.com/sherraKey/keycheck/refs/heads/main/Keys"))()
...
VersionText.Text = "Premium V4.UPDATE"
